...
Eigen::VectorXd rProp(std::function<Eigen::VectorXd(const Eigen::VectorXd)> gradient_func,
                      ...
                      const Eigen::MatrixXd& limits, double epsilon, int max_nb_guess = 1000, double eta_pos = 1.2,
                      double eta_neg = 0.5);
...
Eigen::VectorXd rProp(GaussianProcess& gp, const Eigen::VectorXd& initial_guess,
                      ...
                      int max_nb_guess = 1000, double eta_pos = 1.2, double eta_neg = 0.5);
...
Eigen::VectorXd randomizedRProp(std::function<Eigen::VectorXd(const Eigen::VectorXd)> gradient_func,
                                ...
                                const Eigen::MatrixXd& limits, double epsilon, int nb_trials, int max_nb_guess = 1000,
                                double eta_pos = 1.2, double eta_neg = 0.5);
